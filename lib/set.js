...
import SuperSlicer from "./superslicer.js";
import { existsSync, mkdirSync, copyFileSync } from 'fs';
import Plater from "./plater.js";
import DirectoryFile from './directoryfile.js';
import PlaterFile from './platerfile.js';
    ...
    copyFiles(files, dir) {
        ...
        files.forEach(file => {
            for (let index = 0; index < file.times; index++) {
                copyFileSync(file.name, dir+"/"+fileI+"_"+index+"_"+file.file);
                fileI++;
            }
        });
    }
